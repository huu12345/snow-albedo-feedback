...
# Models - change to model of choice, or create model_list
 ...
 @ i=1
 foreach ALB (/home/hujl/obs_data/ERA5-land/grid_1.0/ERA5-Land_albedo_monthly_NH_grid1.0_1950-2022.nc)
 foreach SNC (/home/hujl/obs_data/ERA5-land/grid_1.0/ERA5-Land_snow-cover_monthly_NH_grid1.0_1950-2022.nc)
 foreach TAS (/home/hujl/obs_data/ERA5-land/grid_1.0/ERA5-Land_2m-temperature_monthly_NH_grid1.0_1950-2022.nc)
 @ i ++

 set model = ERA5-Land${i} || exit 1
 echo ${model}
...
# This is the snc file (to be created if convert_snw > 0)
 ...
 set prsn_file = /home/hujl/obs_data/ERA5-land/grid_1.0/ERA5-Land_snowfall_monthly_NH_grid1.0_1950-2022.nc || exit 1
...
# This is the land mask file
 ...
 set outdir_root = /home/hujl/SAF_time/NH45_dTNH45/paper4_reply_noGLASS/reviewer3_amip/data_snow_albedo/decadal/result_ERA5-Land || exit 1
 # Set work directory
 set work = /home/hujl/SAF_time/NH45_dTNH45/paper4_reply_noGLASS/reviewer3_amip/data_snow_albedo/decadal/work_ERA5-Land || exit 1
