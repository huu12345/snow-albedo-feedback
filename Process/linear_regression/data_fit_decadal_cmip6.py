...
# 输入路径
inpath_model_DS = "/home/hujl/SAF_time/NH45_dTNH45/paper3_reply/reviewer3_amip/data_snow_albedo/decadal/result_cmip6/"
...
for i in range(n_model6):
        ...
        # 构建文件路径
        file1 = os.path.join(inpath_model_DS, f"delta_tas.{m6}.EASE_grid.nc")
        file2 = os.path.join(inpath_model_DS, f"delta_alpha_snow.{m6}.EASE_grid.nc")
        file3 = os.path.join(inpath_model_DS, f"delta_prsn.{m6}.EASE_grid.nc")
        file4 = os.path.join(inpath_model_DS, f"snc.all.pr1.{m6}.EASE_grid.nc")
        file5 = os.path.join(inpath_model_DS, f"snc.all.pr2.{m6}.EASE_grid.nc")
...
out.to_netcdf(outpath+'data_fit_decadal_cmip6.nc')
