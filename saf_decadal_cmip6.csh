...
#
foreach model (ACCESS-CM2 ACCESS-ESM1-5 BCC-CSM2-MR BCC-ESM1 CanESM5 CAS-ESM2-0 \
CESM2 CESM2-FV2 CESM2-WACCM CESM2-WACCM-FV2 CIESM CMCC-CM2-HR4 \
CMCC-CM2-SR5 CNRM-CM6-1 CNRM-CM6-1-HR CNRM-ESM2-1 E3SM-2-0 E3SM-2-0-NARRM \
E3SM-2-1 EC-Earth3 EC-Earth3-AerChem EC-Earth3-CC EC-Earth3-Veg EC-Earth3-Veg-LR \
FGOALS-f3-L FGOALS-g3 GISS-E2-1-G GISS-E2-2-G GISS-E3-G HadGEM3-GC31-LL \
HadGEM3-GC31-MM IPSL-CM6A-LR IPSL-CM6A-MR1 KIOST-ESM MIROC6 MIROC-ES2L \
MPI-ESM-1-2-HAM MPI-ESM1-2-HR MPI-ESM1-2-LR MRI-ESM2-0 NorCPM1 NorESM2-LM \
...
# This is the land mask file
 ...
 set outdir_root = /home/hujl/SAF_time/NH45_dTNH45/paper3_reply/data_amip/decadal_minus_first/result/result_cmip6 || exit 1
 # Set work directory
 set work = /home/hujl/SAF_time/NH45_dTNH45/paper3_reply/data_amip/decadal_minus_first/result/work_cmip6 || exit 1
...
# Snow Threshold - the minimum amount of snow cover required to include a grid cell in the analysis
 ...
 # Set the snow cover threshold - we will calculate SAF all cells with more than 0.25 snc (previously used 0.1)
  ...
  set save_vars = (alpha_land.wgt delta_albedo delta_snc delta_tas mean_alpha_snow.wgt delta_alpha_snow albedo.wgt snc tas mean_snow albedo.wgt.pr1 snc.pr1 tas.pr1 albedo.wgt.pr2 snc.pr2 tas.pr2) || exit 1
  ...
  foreach k (k1 k2 k1k2 k3_res k3 k4 k5 alpha_land.wgt delta_albedo delta_snc delta_tas mean_alpha_snow.wgt delta_alpha_snow albedo.wgt snc tas mean_snow albedo.wgt.pr1 snc.pr1 tas.pr1 albedo.wgt.pr2 snc.pr2 tas.pr2) || exit 1
