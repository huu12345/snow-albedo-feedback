...
**DOI Git project initialized: 9 Apr 2026**
...
- compute snow albedo feedback
- compute snow albedo for fitting
- compute fitting regerssion
...
- Each ncl is named according to the figure number in the paper.
