...
- snow_albedo_feedback \
  This folder is used to calculate NET, SNC, and TEM feedback on the seasonal and decadal timescales. Each shell script is named according to timescales and datasets.
